...
export default function Contact() {
  ...
  return (
    ...
    // > */}
      <Head>
        <title>Email Toast</title>
      </Head>
      <div className="bg-blue shadow-md rounded px-8 pt-6 pb-8 w-full max-w-md">
        <h1 className="text-3xl font-bold mb-4 text-center text-gray-800">Email Toast!</h1>
        ...
        <div className="mt-4 text-center">
          <a>Email form made by Toast aka Dolphin#6086! Hope you enjoy!</a>
        </div>
      </div>
      {showMessageModal && (
