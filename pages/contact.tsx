...
export default function Contact() {
  ...
  return (
    <div
    className={`${styles.contactContainer} ${styles.gradientBackground}`}
    >
      {/* color is #08353d */}
    {/* // <div
    ...
    // > */}
      <Head>
        <title>Email Brick</title>
      </Head>
      <div className="bg-blue shadow-md rounded px-8 pt-6 pb-8 w-full max-w-md">
        <h1 className="text-3xl font-bold mb-4 text-center text-gray-800">Email Brick!</h1>
        ...
        <div className="mt-4 text-center">
          <a>Email form made by Brick aka Dolphin#6086! Hope you enjoy!</a>
        </div>
      </div>
      {showMessageModal && (
